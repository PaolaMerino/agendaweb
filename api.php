...
*/
$pdo= new PDO("mysql:host=localhost;dbname=bdagenda","root","");
...
$consulta = "SELECT COUNT(*) FROM tbleventos WHERE start='$inicio'";
$statement = $pdo->prepare($consulta);
$statement->execute();
if ($statement->fetchColumn() > 0) {
    echo 'Ya existe un registro con los mismos valores.';
